          ...
          <div className="row gx-4 gx-lg-5 align-items-center">
            ...
            <div className="col-md-6">
                ...
                <div className="product-detail-data-container row" itemProp="offers" itemType="http://schema.org/Offer">
                  ...
                  <div className="col-8">
                    ...
                    <div className="product-detail-price-container">
                      ...
                      <span className="product-detail-price with-list-price">
                        <div className="unit-price">883.00&nbsp;
                        </div>
                        <div className="badge badge-danger product-discount-badge">-30%</div>
                      </span>
                    </div>
                          ...
                          <div className="modal-dialog" role="document">
                            <div className="modal-content">
                              <div className="modal-header">
                                <h5 className="modal-title">Gastos de envío</h5>
                                <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Cerca">
                                </button>
                              </div>
              ...
              <div className="d-grid">
                <button className="btn btn-padding btn-primary btn-buy" title="¡Lo quiero!" aria-label="¡Lo quiero!">
